-  in general thì hàm sinh (g là 1 dãy tổng vô hạn kiểu A(x) = a_0 + a_1x+ a_2x^2 + a_3x^3 +... và có thể được biễu diễn ở dạng rút gọn (ví dụ như là 1/1-x) và mục đích tồn tại của hàm sinh này là vì nó có thể dùng để mô hình hóa một số bài toán tổ hợp và giúp ta giải các bài toán đấy một cách dễ dàng thay vì các phương pháp đếm thủ công
