...
Ở **hai chỗ**. Thứ nhất, tín hiệu **thưa**: reward chỉ nói attempt đúng hay sai, chứ không nói **sai ở đâu** — nên mô hình khó biết phải sửa token nào, đây chính là bài toán *credit assignment*. Thứ hai, **không có gì để bắt chước**: đúng những bài khó thì mô hình gần như **không tự sinh nổi một lời giải đúng nào**, nên cũng chẳng có ví dụ đúng để học theo.
