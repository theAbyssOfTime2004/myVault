...
Vấn đề đặt ra rất cụ thể: ta muốn một mô hình **tự giải được một bài khó mà hiện tại nó chưa giải nổi**, chỉ dựa vào **chính các attempt của nó** và một **reward verifiable** (đúng/sai). Vậy trở ngại nằm ở đâu?
