...
\textbf{‡ Projected result} (extrapolated from the current real draft
under the stated hypotheses; not yet run). See the title-page banner and
\texttt{BESTCASE\_NOTES.md}.
