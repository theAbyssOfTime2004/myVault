\chapter{Chapter 2 --- Background and Related Work}\label{chapter-2-background-and-related-work}
...
\section{2.1 RLVR and GRPO}\label{rlvr-and-grpo}
...
\section{2.2 SDPO}\label{sdpo}

\subsection{2.2.1 The self-teacher and rich feedback}\label{the-self-teacher-and-rich-feedback}
...
\subsection{2.2.2 The loss and dense credit assignment}\label{the-loss-and-dense-credit-assignment}
...
\begin{center}\begin{tikzpicture}[font=\footnotesize,>=Latex,every node/.style={draw,rounded corners,align=center,minimum height=0.7cm,text width=3.3cm,inner sep=2pt}]
...
\subsection{2.2.3 Three regimes}\label{three-regimes}
...
\subsection{2.2.4 What drives SDPO: ablations and scaling}\label{what-drives-sdpo-ablations-and-scaling}
...
\section{2.3 Test-time training and discovery@k}\label{test-time-training-and-discoveryk}
...
\section{2.4 The reprompt template and its design space}\label{the-reprompt-template-and-its-design-space}
...
\section{2.5 Epistemic verbalization and suppression}\label{epistemic-verbalization-and-suppression}
...
\section{2.6 SDFT and the leak concern}\label{sdft-and-the-leak-concern}
...
\section{2.7 The gap this thesis addresses}\label{the-gap-this-thesis-addresses}
...
Numbered per the master bibliography (\texttt{00\_references.md}): {[}1{]} Hübotter et al.~2026 · {[}2{]} Kim et al.~2026 · {[}3{]} Shenfeld et al.~2026 · {[}4{]} lasgroup SDPO repo · {[}6{]} LiveCodeBench · {[}8{]} GRPO / DeepSeekMath · {[}9{]} Chen et al.~2021 · {[}11{]} Agarwal et al.~2023 · {[}12{]} Dolan \& Moré 2002 · {[}13{]} Hinton et al.~2015.
