...
\begin{quote}
\textbf{‡ This is the best-case / projected draft.} Results marked ‡ are projections extrapolated from the current real draft under the stated hypotheses, included to show how the work develops with more compute and time. The factual baseline is the current real draft.
\end{quote}
