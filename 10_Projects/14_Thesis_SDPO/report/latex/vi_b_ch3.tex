...
Ký hiệu trong chương này phản chiếu bài báo gốc, Hübotter và cộng sự~{[}1{]}, để hai bên có thể đọc song song với nhau.
...
\item
  self-teacher \(\pi_\theta(\cdot \mid x, c)\), cùng mô hình đó nhưng được điều kiện hóa thêm trên một privileged context \(c\).
\end{itemize}
