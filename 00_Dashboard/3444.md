...
Tổng hợp các dạng bài kết hợp **bảo toàn động lượng + bảo toàn cơ năng** trong 10 đề đã ôn:

## Dạng A — "Con lắc đạn / va chạm mềm" (2 bước)

**Đề 5 Câu 1**, **Đề 7 Câu 2** — cùng 1 khuôn mẫu: đạn bắn vào bao cát treo dây, dây lệch góc $\theta$ sau va chạm.

**Thứ tự đúng:**

1. Bảo toàn **cơ năng** (con lắc đung đưa SAU va chạm, từ góc $\theta$ → tìm $h$ → tìm $v'$)
2. Bảo toàn **động lượng** (va chạm mềm, TRƯỚC đó → từ $v'$ tìm $v$ ban đầu của đạn)

## Dạng B — "Con lắc + va chạm đàn hồi + trượt lên cao" (3 bước, phức tạp hơn)

**Đề 6 Câu 1** — quả cầu treo dây lệch góc, thả xuống, va chạm **đàn hồi** (không phải mềm) với vật khác, rồi vật đó trượt lên đường cong không ma sát.

**Thứ tự:**

1. Bảo toàn **cơ năng** (con lắc rơi từ góc $\theta$ xuống thấp nhất → tìm $v$ trước va chạm)
2. Va chạm **đàn hồi** (bảo toàn động lượng + động năng cùng lúc → tìm $v'_m, v'_M$)
3. Bảo toàn **cơ năng** lần nữa (vật $M$ trượt lên cao → tìm độ cao cực đại)

→ Đây là dạng **"bánh kẹp"**: cơ năng – va chạm – cơ năng, khác Dạng A chỉ có 2 bước.

## Dạng C — "Trượt không ma sát + va chạm đàn hồi + đoạn có ma sát" (kết hợp 3 công cụ)

**Đề 10 Câu 1** — vật trượt không ma sát (A→C, bảo toàn cơ năng thuần), va chạm **đàn hồi** tại C, rồi đoạn tiếp theo (CD) **có ma sát** (không dùng bảo toàn cơ năng thuần được nữa, phải dùng **định lý động năng** — công của ma sát = biến thiên động năng).

**Thứ tự:**

1. Bảo toàn **cơ năng** (A→C, không ma sát → tìm $v_C$)
2. Va chạm **đàn hồi** tại C (bảo toàn động lượng + động năng → tìm $v'_A, v'_C$)
3. **Định lý động năng** (không phải bảo toàn cơ năng thuần, vì CD có ma sát) → tìm quãng đường/vận tốc tại D

## Dạng D — Bảo toàn cơ năng dùng làm phương pháp THAY THẾ (không phải va chạm)

**Đề 9 Câu 1c** — không có va chạm, nhưng dùng **định lý động năng** (dạng tổng quát của bảo toàn cơ năng, có tính đến công ma sát) như **cách kiểm chứng thứ 2** cho kết quả gia tốc đã tìm bằng Newton+$\tau=I\beta$ ở câu a.

---

**Nhận xét chung:** cả 3 dạng A, B, C đều có **chung 1 nguyên tắc cốt lõi** — bảo toàn động lượng dùng cho **thời điểm va chạm** (tức thời), còn bảo toàn cơ năng dùng cho **giai đoạn di chuyển liên tục** (trước/sau va chạm, không ma sát) — không bao giờ trộn lẫn 2 định luật vào cùng 1 bước tính.

Tổng hợp các dạng bài **khí lý tưởng / nhiệt động lực học** trong 10 đề đã ôn:

## Dạng phổ biến nhất — Chu trình 3 quá trình: đẳng nhiệt + đẳng áp + đẳng tích

**Đề 2 Câu 2, Đề 3 Câu 2, Đề 6 Câu 3** — **CÙNG MỘT SỐ LIỆU** ($P=5,1$ atm; $V=10,50$ lít), chỉ đổi tên trạng thái (1,2,3 hoặc A,B,C) và thứ tự quá trình khác nhau chút ít. Đáng chú ý: đây gần như là **CÙNG 1 BÀI lặp lại 3 lần** trong đề — xác suất cao đề thi thật cũng ra dạng này.

→ Ôn kỹ dạng này: xác định trạng thái nào đẳng nhiệt (dùng $P_1V_1\ln(V_f/V_i)$), đẳng áp ($A=P\Delta V$), đẳng tích ($A=0$).

## Dạng có đoạn nhiệt (không có đẳng nhiệt) — 3 quá trình

**Đề 4 Câu 3, Đề 5 Câu 3, Đề 9 Câu 2** — cấu trúc: đoạn nhiệt + đẳng áp + đẳng tích (không có đẳng nhiệt nào). Cần cẩn thận công thức $PV^\gamma=const$ và $\Delta U=\frac{i}{2}\Delta(PV)$ cho đoạn nhiệt (vì $Q=0$).

## Dạng 4 quá trình (phức tạp hơn — máy lạnh/Otto)

- **Đề 1 Câu 4:** máy lạnh, 4 quá trình (đoạn nhiệt, đẳng áp, đẳng nhiệt, đẳng áp) → dùng $W$ (nhận), hệ số làm lạnh $\varepsilon$
- **Đề 7 Câu 3:** chu trình Otto (động cơ đốt trong), 4 quá trình xen kẽ đoạn nhiệt-đẳng tích → có công thức riêng $\eta_{Otto}=1-1/k^{\gamma-1}$
- **Đề 8 Câu 2:** 4 quá trình khép kín (đẳng nhiệt, đoạn nhiệt, đẳng áp, đẳng tích), không cho $n$

## Dạng đặc biệt — Chu trình Carnot

**Đề 10 Câu 3:** chỉ gồm 2 đẳng nhiệt + 2 đoạn nhiệt, có công thức riêng ($\eta=1-T_c/T_h$, $V_1V_3=V_2V_4$).

---

## 3 "mẹo" xuất hiện xuyên suốt — nhớ kỹ

1. **Dùng $PV$ thay $nRT$** — không cần biết $n$: áp dụng ở **8/10 đề** (trừ Đề 1, Đề 7 có cho đủ số liệu để tính $n$ trực tiếp).
2. **Xác định động cơ hay máy lạnh** trước khi chọn $A$ hay $W$ — chỉ 2/10 đề nói rõ tên máy (Đề 1 "máy lạnh", Đề 7 "động cơ Otto"), còn lại phải suy từ câu hỏi "hiệu suất" ở cuối bài.
3. **So sánh hiệu suất khi đổi loại 1 quá trình** (Đề 6 Câu 3 phần d) — dạng nâng cao, cần xác định đại lượng nào giữ nguyên (thường là $V$) khi đổi loại quá trình.

**Đánh giá:** phần nhiệt bạn đã ôn khá đều — 3 lần lặp lại dạng "đẳng nhiệt+áp+tích" là dấu hiệu tốt (nắm chắc dạng phổ biến nhất). Điểm cần chú ý thêm: dạng 4 quá trình (máy lạnh/Otto) phức tạp hơn, nên xem lại nếu còn thời gian.

**Không đề nào trong 10 đề đã ôn là bơm nhiệt** — cả 10 đều là động cơ nhiệt (9 đề) hoặc máy lạnh (Đề 1, ghi rõ tên). Nhưng đây là câu hỏi tốt để chuẩn bị trước, vì 31 đề còn lại có thể có.

## Bơm nhiệt về bản chất GIỐNG HỆT máy lạnh

Bơm nhiệt và máy lạnh **dùng chung 1 loại chu trình vật lý** (cùng chiều quay trên đồ thị P-V, cùng cần tốn công $W$ để "bơm" nhiệt từ nơi lạnh sang nơi nóng) — chỉ khác nhau ở **mục đích sử dụng**:

- **Máy lạnh:** mục đích là hút nhiệt RA khỏi nơi lạnh (VD giữ tủ lạnh mát) → quan tâm đến $Q_c$
- **Bơm nhiệt:** mục đích là bơm nhiệt VÀO nơi nóng (VD sưởi ấm phòng) → quan tâm đến $Q_h$

→ Cùng 1 máy vật lý, chỉ đổi cách nhìn "cái nào là kết quả hữu ích".

## Cách làm nếu gặp đề bơm nhiệt

**Bước 1-2:** giống hệt máy lạnh — dùng quy ước $W$ (nhận), tính $Q$ từng quá trình, tính $W_{total}$ như bình thường.

**Bước 3 — chỉ khác ở công thức cuối:** $$COP_{sưởi} = \frac{|Q_h|}{W}$$ (thay vì $\varepsilon=\dfrac{|Q_c|}{W}$ như máy lạnh)

## Công thức liên hệ nhanh (mẹo kiểm tra chéo)

Vì $|Q_h| = |Q_c| + W$ (bảo toàn năng lượng: nhiệt tỏa ra nóng = nhiệt hút từ lạnh + công đã bỏ vào): $$\boxed{COP_{sưởi} = \varepsilon + 1}$$

Nếu bài cho sẵn cả 2 câu hỏi ($\varepsilon$ và $COP$) thì tính 1 cái, cộng thêm $1$ ra ngay cái còn lại — không cần tính lại từ đầu.

**Dấu hiệu nhận biết đề bơm nhiệt:** đề sẽ dùng chữ **"bơm nhiệt"**, **"máy sưởi"**, hoặc hỏi **"hệ số làm nóng" / "COP"** — khác hẳn chữ "hiệu suất" (động cơ) hay "hệ số làm lạnh" (máy lạnh).