...
\begin{itemize}[leftmargin=1.2em, itemsep=0.05em, parsep=0pt, topsep=0pt]
    ...
    \item Built the chat memory layer, consisting of session state and history saved to \textbf{Azure Blob Storage} with \textbf{Redis} caching, so the bot remembers each user across turns and keeps a coherent persona in English and Dutch.
\end{itemize}
